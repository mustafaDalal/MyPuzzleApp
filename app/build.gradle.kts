...
android {
    namespace = "com.md.mypuzzleapp"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.md.mypuzzleapp"
        minSdk = 24
        targetSdk = 35
        versionCode = 3
        versionName = "1.0"
    ...
    // Define signing configs BEFORE buildTypes so they can be referenced
    signingConfigs {
        if (hasKeystore) {
            create("release") {
    ...
    buildTypes {
        release {
            // Enable code and resource shrinking for Play Store release builds
            isMinifyEnabled = true
            isDebuggable = false
            isShrinkResources = true
            proguardFiles(getDefaultProguardFile("proguard-android-optimize.txt"), "proguard-rules.pro")

            // Apply release signing config so that the AAB/APK is signed
            if (hasKeystore) {
...
dependencies {
    ...
    // Compose and View interop for Drag and Drop
